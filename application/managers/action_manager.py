...
class ActionManager(QObject):
    ...
    def setup_actions(self, window: QWidget, shortcuts: Shortcuts, 
                      file_manager, view_manager, shell_manager, undo_manager):
        """
        ...
        slots: Dict[ShortcutAction, Optional[Callable]] = {
            ...
            ShortcutAction.REFRESH:         lambda: shell_manager.current_pane.scanner.scan_directory(shell_manager.current_pane.current_path) if shell_manager.current_pane else None,
            ShortcutAction.FIND:            lambda: shell_manager.navigationRequested.emit("FOCUS"),
            ShortcutAction.FOCUS_PATH_BAR:  lambda: shell_manager.navigationRequested.emit("FOCUS"),
