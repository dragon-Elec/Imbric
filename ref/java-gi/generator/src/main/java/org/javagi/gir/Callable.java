...
import static org.javagi.util.CollectionUtils.findAny;
...
public sealed interface Callable
    ...
    /**
     * Set this attribute (with a metadata rule) when a void function should "return this".
     */
    ...
    /**
     * Detect if this is an asynchronous function.
     */
    default boolean isAsync() {
        String cIdentifier = callableAttrs().cIdentifier();
        String finishFunc = callableAttrs().finishFunc();
        return (cIdentifier != null && cIdentifier.endsWith("_async")) || finishFunc != null;
    }
}
