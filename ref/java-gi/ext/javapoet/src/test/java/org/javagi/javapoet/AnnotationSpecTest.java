...
public final class AnnotationSpecTest {
  ...
  @Test public void defaultAnnotation() {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "import org.javagi.javapoet.AnnotationSpecTest;\n"
        + "\n"
  ...
  @Test public void defaultAnnotationWithImport() {
    ...
    JavaFile file = JavaFile.builder("org.javagi.javapoet", typeBuilder.build()).build();
  ...
  @Test public void emptyArray() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@org.javagi.javapoet.AnnotationSpecTest.HasDefaultsAnnotation(" + "n = {}" + ")");
    builder.addMember("m", "$L", "{}");
    assertThat(builder.build().toString())
        .isEqualTo(
            "@org.javagi.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
                + "n = {}, m = {}"
                + ")");
  }
  ...
  @Test public void dynamicArrayOfEnumConstants() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@org.javagi.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = org.javagi.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
            + ")");
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@org.javagi.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = {"
            + "org.javagi.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", org.javagi.javapoet.AnnotationSpecTest.Breakfast.WAFFLES"
            + ", org.javagi.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
            + "})");
  ...
  @Test public void defaultAnnotationToBuilder() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@org.javagi.javapoet.AnnotationSpecTest.HasDefaultsAnnotation("
            + "o = org.javagi.javapoet.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", p = 1701"
            + ", f = 11.1"
            + ", m = {9, 8, 1, 123}"
            + ", l = java.lang.Override.class"
            + ", j = @org.javagi.javapoet.AnnotationSpecTest.AnnotationA"
            + ", q = @org.javagi.javapoet.AnnotationSpecTest.AnnotationC(\"bar\")"
  ...
  private String toString(TypeSpec typeSpec) {
    return JavaFile.builder("org.javagi.tacos", typeSpec).build().toString();
  }
}
