...
public final class TypeSpecTest {
  private final String tacosPackage = "org.javagi.tacos";
  private static final String donutsPackage = "org.javagi.donuts";
  ...
  @Test public void typeVariableWithBounds() {
    AnnotationSpec a = AnnotationSpec.builder(ClassName.get("org.javagi.tacos", "A")).build();
    TypeVariableName p = TypeVariableName.get("P", Number.class);
  ...
  @Test public void classImplementsExtends() throws Exception {
    ...
    ClassName food = ClassName.get("org.javagi.tacos", "Food");
  ...
  @Test public void referencedAndDeclaredSimpleNamesConflict() throws Exception {
    ...
    assertThat(toString(top)).isEqualTo(""
        + "package org.javagi.tacos;\n"
        + "\n"
        + "import org.javagi.donuts.Bottom;\n"
        + "\n"
        + "class Top {\n"
        + "  Top internalTop;\n"
        + "\n"
        ...
        + "\n"
        + "  org.javagi.donuts.Top externalTop;\n"
        + "\n"
        ...
        + "    org.javagi.donuts.Top externalTop;\n"
        + "\n"
        + "    org.javagi.donuts.Bottom externalBottom;\n"
        + "\n"
        + "    class Bottom {\n"
        + "      Top internalTop;\n"
        + "\n"
  ...
  @Test public void simpleNamesConflictInThisAndOtherPackage() throws Exception {
    ...
    assertThat(toString(gen)).isEqualTo(""
        ...
        + "  Other internalOther;\n"
        + "\n"
        + "  org.javagi.donuts.Other externalOther;\n"
        + "}\n");
  }

  @Test public void simpleNameConflictsWithTypeVariable() {
    ClassName inPackage = ClassName.get("org.javagi.tacos", "InPackage");
    ClassName otherType = ClassName.get("com.other", "OtherType");
    ClassName methodInPackage = ClassName.get("org.javagi.tacos", "MethodInPackage");
    ...
    assertThat(toString(gen)).isEqualTo(""
        ...
        + "  org.javagi.tacos.InPackage inPackage;\n"
        + "\n"
        + "  com.other.OtherType otherType;\n"
        + "\n"
        + "  <MethodInPackage, MethodOtherType> void withTypeVariables() {\n"
        + "    org.javagi.tacos.MethodInPackage inPackage = null;\n"
        ...
        + "    org.javagi.tacos.InPackage inPackage = null;\n"
        + "  }\n"
        + "}\n");
  }
  ...
  @Test public void constructorToString() throws Exception {
    ...
    assertThat(constructor.toString()).isEqualTo(""
        + "public Constructor(org.javagi.tacos.Taco taco) {\n"
        + "  this.taco = taco;\n"
        + "}\n");
  }
  ...
  @Test public void parameterToString() throws Exception {
    ...
    assertThat(parameter.toString())
        .isEqualTo("@javax.annotation.Nullable final org.javagi.tacos.Taco taco");
  }
  ...
  @Test public void tryCatch() {
    TypeSpec taco = TypeSpec.classBuilder("Taco")
        .addMethod(MethodSpec.methodBuilder("addTopping")
            .addParameter(ClassName.get("org.javagi.tacos", "Topping"), "topping")
            .beginControlFlow("try")
            .addCode("/* do something tricky with the topping */\n")
            .nextControlFlow("catch ($T e)",
                ClassName.get("org.javagi.tacos", "IllegalToppingException"))
            .endControlFlow()
            .build())
        .build();
    assertThat(toString(taco)).isEqualTo(""
  ...
  @Test public void freeTextBlock() {
    TypeSpec taco = TypeSpec.classBuilder("Taco")
        .addFreeTextBlock(CodeBlock.builder()
            .addStatement("public $T foo = $S", String.class, "FOO")
            .build())
        .build();
    assertThat(toString(taco)).isEqualTo(""
            + "package org.javagi.tacos;\n"
