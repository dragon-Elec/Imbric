...
public final class JavaFileTest {
  ...
  @Test public void importStaticForCrazyFormatsWorks() {
    ...
    JavaFile.builder("org.javagi.tacos",
  ...
  @Test public void importStaticMixed() {
    JavaFile source = JavaFile.builder("org.javagi.tacos",
        TypeSpec.classBuilder("Taco")
            .addStaticBlock(CodeBlock.builder()
  ...
  @Test public void noImports() throws Exception {
    String source = JavaFile.builder("org.javagi.tacos",
  ...
  @Test public void annotatedTypeParam() throws Exception {
    String source = JavaFile.builder("org.javagi.tacos",
        TypeSpec.classBuilder("Taco")
            .addField(ParameterizedTypeName.get(ClassName.get(List.class),
                ClassName.get("org.javagi.meat", "Chorizo")
                    .annotated(AnnotationSpec.builder(ClassName.get("org.javagi.tacos", "Spicy"))
                        .build())), "chorizo")
            .build())
        .build()
        .toString();
    assertThat(source).isEqualTo(""
        ...
        + "\n"
        + "import java.util.List;\n"
        + "import org.javagi.meat.Chorizo;\n"
        + "\n"
        + "class Taco {\n"
  ...
  @Test public void skipJavaLangImportsWithConflictingClassLast() throws Exception {
    ...
    String source = JavaFile.builder("org.javagi.tacos",
        TypeSpec.classBuilder("Taco")
            ...
            .addField(ClassName.get("org.javagi.soda", "Float"), "beverage")
            .build())
    ...
    assertThat(source).isEqualTo(""
        ...
        + "  Float litres;\n"
        + "\n"
        + "  org.javagi.soda.Float beverage;\n" // Second 'Float' is fully qualified.
        + "}\n");
  }

  @Test public void skipJavaLangImportsWithConflictingClassFirst() throws Exception {
    // Whatever is used first wins! In this case the Float in org.javagi.soda is imported.
    String source = JavaFile.builder("org.javagi.tacos",
        TypeSpec.classBuilder("Taco")
            .addField(ClassName.get("org.javagi.soda", "Float"), "beverage")
            .addField(ClassName.get("java.lang", "Float"), "litres")
        ...
        TypeSpec.classBuilder("A")
            .addType(TypeSpec.classBuilder("B")
                ...
                .addType(TypeSpec.classBuilder("C")
                    .addField(ClassName.get("org.javagi.tacos", "A", "Twin", "D"), "d")
                    .build())
                .build())
  ...
  @Test public void nestedClassAndSuperclassShareName() throws Exception {
    String source = JavaFile.builder("org.javagi.tacos",
        TypeSpec.classBuilder("Taco")
            .superclass(ClassName.get("org.javagi.wire", "Message"))
            .addType(TypeSpec.classBuilder("Builder")
                .superclass(ClassName.get("org.javagi.wire", "Message", "Builder"))
                .build())
            .build())
        .build()
        .toString();
    assertThat(source).isEqualTo(""
        + "package org.javagi.tacos;\n"
        + "\n"
        + "import org.javagi.wire.Message;\n"
        + "\n"
  ...
  @Test public void conflictingAnnotationReferencedClass() throws Exception {
    String source = JavaFile.builder("org.javagi.tacos",
        TypeSpec.classBuilder("Taco")
            .addAnnotation(AnnotationSpec.builder(ClassName.get("org.javagi.tacos", "MyAnno"))
    ...
    String source = JavaFile.builder("org.javagi.tacos",
        TypeSpec.classBuilder("Taco")
            .superclass(ParameterizedTypeName.get(
                ClassName.get(Comparable.class), ClassName.get("org.javagi.tacos", "Taco")))
            .build())
        .build()
        .toString();
    assertThat(source).isEqualTo(""
  ...
  @Test public void packageClassConflictsWithNestedClass() throws Exception {
    String source = JavaFile.builder("org.javagi.tacos",
        TypeSpec.classBuilder("Taco")
            .addField(ClassName.get("org.javagi.tacos", "A"), "a")
  ...
  @Test public void modifyStaticImports() throws Exception {
    JavaFile.Builder builder = JavaFile.builder("org.javagi.tacos",
        TypeSpec.classBuilder("Taco")
            .build())
  ...
  @Test public void avoidClashesWithNestedClasses_viaSuperinterfaceType() {
    String source = JavaFile.builder("org.javagi.tacos",
        ...
        .build()
        .toString();
    assertThat(source).isEqualTo("package org.javagi.tacos;\n"
        + "\n"
        + "import org.javagi.javapoet.JavaFileTest;\n"
        + "import other.Foo;\n"
        + "import other.NestedTypeC;\n"
        + "\n"
  ...
  public void avoidClashes_parentChild_superclass_type() {
    String source = JavaFile.builder("org.javagi.javapoet",
        childTypeBuilder().superclass(Parent.class).build())
        .build()
        .toString();
    assertThat(source).isEqualTo("package org.javagi.javapoet;\n"
        + "\n"
        + "import java.lang.String;\n"
        + "\n"
