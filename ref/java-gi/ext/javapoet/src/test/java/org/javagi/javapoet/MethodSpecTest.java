...
import static org.javagi.javapoet.TestUtil.findFirst;
...
public final class MethodSpecTest {
  ...
  @Test public void overrideFinalClassMethod() {
    ...
    try {
      ...
      assertThat(expected).hasMessageThat().isEqualTo(
          "Cannot override method on final class org.javagi.javapoet.MethodSpecTest.FinalClass");
    }
  }
  ...
  @Test public void overrideDoesNotCopyParameterAnnotations() {
    ...
    ClassName implClassName = ClassName.get("org.javagi.javapoet", "Impl");
