...
This repository contains a fork of [github.com/square/javapoet][square] at commit #b9017a9, intended
for use with [Java-GI][javagi]. Compared to the original, there are several following modifications:

- Updated package name to `org.javagi.javapoet`
- Build with Gradle
- Added support for Markdown-formatted Javadoc (JEP 467)
- Generate parts of classes with "raw" CodeBlocks, bypassing the MethodSpec/FieldSpec API
...
-------
    ...
    Copyright 2026 Jan-Willem Harmannij
 ...
 [square]: https://github.com/square/javapoet/
 [javagi]: https://java-gi.org/
