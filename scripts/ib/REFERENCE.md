...
Scans `src/**/*.kt`, extracts public declarations via regex, compares against
`### [FILE: name]` blocks in `*context.md` files. Reports undocumented APIs.

## OutputFilter

Shared by `dev`, `hot`, `run`, `exec`. Behavior:
