...
Pane {
    ...
    // Header Configuration (Now bound directly to ShellManager)
    // No local properties needed
    ...
    ColumnLayout {
        ...
        SidebarHeader {
            ...
            text: shellManager ? shellManager.quickAccess.title : ""
            icon: shellManager ? root.getIconChar(shellManager.quickAccess.icon) : ""
            
            // Controls: Grid Size & Add Folder
            RowLayout {
                spacing: 2
                Label { text: "Grid:"; font.pixelSize: 10; color: sysPalette.text; opacity: 0.6 }
                ToolButton {
                    text: "-"
                    font.pixelSize: 14
                    flat: true
                    onClicked: console.log("Grid Size: Decrease")
                ...
                ToolButton {
                    ...
                    font.pixelSize: 14
                    flat: true
                    onClicked: console.log("Grid Size: Increase")
                    background: Rectangle { color: parent.down ? Qt.rgba(sysPalette.text.r, sysPalette.text.g, sysPalette.text.b, 0.1) : "transparent"; radius: 4 }
                }
            }
            ...
            // Separator
            Rectangle { 
                width: 1; height: 16; color: sysPalette.mid; opacity: 0.3 
            ...
            ToolButton {
                ...
                onClicked: console.log("Quick Access: Add clicked")
                background: Rectangle { color: parent.down ? Qt.rgba(sysPalette.text.r, sysPalette.text.g, sysPalette.text.b, 0.1) : "transparent"; radius: 4 }
            }
            ToolButton {
                text: "⚙"
                ...
                flat: true
                opacity: hovered ? 1.0 : 0.6
                onClicked: console.log("Quick Access: Settings clicked")
                background: Rectangle { color: parent.down ? Qt.rgba(sysPalette.text.r, sysPalette.text.g, sysPalette.text.b, 0.1) : "transparent"; radius: 4 }
            }
        }

        Item {
            visible: !qaHeader.collapsed
            Layout.fillWidth: true
            Layout.preferredHeight: flowLayout.height + 12 // Reduced top margin
            Layout.fillHeight: false // Prevent stretching
            Layout.topMargin: 4
                        ...
                        delegate: ItemDelegate {
                            ...
                            contentItem: Column {
                                ...
                                Label {
                                    ...
                                    // Behavior on color { ColorAnimation { duration: 150 } } // Removed behavior on color to avoid potential binding loops or just simplification
                                }
                                Label {
        ...
        SidebarHeader {
            ...
            text: shellManager ? shellManager.volumes.title : ""
            icon: shellManager ? root.getIconChar(shellManager.volumes.icon) : ""
            Layout.topMargin: 8
            ...
            ToolButton {
                ...
                opacity: hovered ? 1.0 : 0.6
                onClicked: { 
                    console.log("Devices: Refresh clicked")
                    // In real app, might trigger shellManager.volumes.scan()
                }
                background: Rectangle { color: parent.down ? Qt.rgba(sysPalette.text.r, sysPalette.text.g, sysPalette.text.b, 0.1) : "transparent"; radius: 4 }
            }
        }
        ...
        // 3. Vertical Spacer
        // Takes up remaining space ONLY when Volumes List is collapsed
        Item {
            Layout.fillWidth: true
